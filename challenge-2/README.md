...
In Challenge 1, you built 5 great agents — but you're manually copying outputs between them. That's fine for testing, but useless at 3 AM when nobody's awake.
...
The workflow handles incidents — but starts from scratch every time. A human SRE gets faster because they remember past incidents. Head to **[Challenge 3: Memory & Learning](../challenge-3/README.md)** to make your system learn.
